...
/*
    ...
    //Junit test for using JQPL with Named params
    ...
    //Junit test for custome query using Native SQL with index
    ...
    //Junit test for custome query using Native SQL with named params
